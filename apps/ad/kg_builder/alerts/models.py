...
# Thresholds used by the checked-in call quality dashboards.  They are seeded
# only when ALERT_SEED_DEMO_RULES is enabled by the demo bootstrap script.
DEMO_ALERT_RULES += [
    {
        "name": "质量低分｜平均质量分不高于 60 分",
        "description": "平均通话质量分不高于 60 分，建议优先复盘话术和邀约动作。",
        "builtin_type": "self",
        "measure_code": "MEAS_avg_call_quality_score",
        "operator": "lte",
        "threshold": 60,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "平均覆盖率偏低｜平均检查点覆盖率不高于 55%",
        "description": "关键信息平均覆盖率不高于 55%，建议补齐客户场景、预算和下一步动作。",
        "builtin_type": "self",
        "measure_code": "MEAS_avg_slot_coverage_rate",
        "operator": "lte",
        "threshold": 0.55,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "低覆盖偏高｜低覆盖通话达到 3 通",
        "description": "同一分析路径低覆盖通话达到 3 通，需要检查信息采集完整性。",
        "builtin_type": "path",
        "measure_code": "MEAS_low_coverage_call_count",
        "operator": "gte",
        "threshold": 3,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "低质量偏多｜低质量通话达到 2 通",
        "description": "同一分析路径低质量通话达到 2 通，需要安排录音复盘。",
        "builtin_type": "path",
        "measure_code": "MEAS_low_quality_call_count",
        "operator": "gte",
        "threshold": 2,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "检查点缺失偏多｜缺失检查点达到 15 项",
        "description": "同一分析路径累计缺失检查点达到 15 项，需要补齐 SOP 关键动作。",
        "builtin_type": "path",
        "measure_code": "MEAS_missing_slot_count",
        "operator": "gte",
        "threshold": 15,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "样本不足｜通话样本不高于 4 通",
        "description": "销售专家样本不高于 4 通时仅作关注提示，避免小样本结论被误读。",
        "builtin_type": "self",
        "measure_code": "MEAS_phone_call_count",
        "operator": "lte",
        "threshold": 4,
        "threshold2": None,
        "dimensions_json": "{}",
    ...
    {
        "name": "SOP未达成集中｜单环节未达成达到 5 通",
        "description": "同一 SOP 环节未达成达到 5 通，应优先统一辅导。",
        "builtin_type": "self",
        "measure_code": "MEAS_quality_record_count",
        "operator": "gte",
        "threshold": 5,
        "threshold2": None,
        "dimensions_json": json.dumps({"DIM_quality_score_level": "未达成"}, ensure_ascii=False),
        "severity": "critical",
        "cooldown_minutes": 15,
    },
    {
        "name": "低质量问题集中｜同类问题达到 2 通",
        "description": "同一销售专家的低质量问题达到 2 通时高亮。",
        "builtin_type": "path",
        "measure_code": "MEAS_quality_record_count",
        "operator": "gte",
        "threshold": 2,
        "threshold2": None,
        "dimensions_json": json.dumps({"DIM_quality_issue_category": "低质量通话"}, ensure_ascii=False),
        "severity": "warning",
        "cooldown_minutes": 15,
    },
    {
        "name": "覆盖问题集中｜同类问题达到 2 通",
        "description": "同一销售专家的关键信息覆盖不足达到 2 通时高亮。",
        "builtin_type": "path",
        "measure_code": "MEAS_quality_record_count",
        "operator": "gte",
        "threshold": 2,
        "threshold2": None,
        "dimensions_json": json.dumps({"DIM_quality_issue_category": "关键信息覆盖不足"}, ensure_ascii=False),
        "severity": "warning",
        "cooldown_minutes": 15,
    },
    {
        "name": "下一步动作缺失集中｜同类问题达到 5 通",
        "description": "同一销售专家的下一步动作未完成达到 5 通时高亮。",
        "builtin_type": "path",
        "measure_code": "MEAS_quality_record_count",
        "operator": "gte",
        "threshold": 5,
        "threshold2": None,
        "dimensions_json": json.dumps({"DIM_quality_issue_category": "下一步动作未完成"}, ensure_ascii=False),
        "severity": "critical",
        "cooldown_minutes": 15,
    },
]
