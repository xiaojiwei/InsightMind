...
@org.hibernate.annotations.Table(appliesTo = "space_owner", comment="空间拥有者")
public class SpaceOwner extends BaseModel {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SpaceOwner)) return false;
        if (!super.equals(o)) return false;
        SpaceOwner that = (SpaceOwner) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), employeeCode, name, mail, authObjectType);
    }
}
