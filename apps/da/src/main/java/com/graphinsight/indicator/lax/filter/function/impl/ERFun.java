...
@Service
public class ERFun implements Function<List, Node> {
    ...
    public Node apply() {
        ...
        //科目 整车收入 code KPI_D01
        operator.getDataList().add("KPI_D01");
        ...
        try {
            ...
            String result = df.format(node.result);
            node.result = Double.valueOf(result);
        } catch (Exception ex) {
            node.result = "-";
        }
