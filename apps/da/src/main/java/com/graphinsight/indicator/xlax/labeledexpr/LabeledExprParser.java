...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		FILTER=10, DIM=11, MUL=12, DIV=13, ADD=14, SUB=15, ID=16, INT=17, STRING=18, 
		NEWLINE=19, WS=20;
	public static final int
		RULE_prog = 0, RULE_stat = 1, RULE_expr = 2, RULE_dims = 3, RULE_filters = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"prog", "stat", "expr", "dims", "filters"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DIM", "MUL", "DIV", "ADD", "SUB", "ID", "INT", "STRING", "NEWLINE", 
			"WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 720900L) != 0 );
			}
		}
	...
	public static class DimContext extends DimsContext {
		public TerminalNode DIM() { return getToken(LabeledExprParser.DIM, 0); }
		public DimContext(DimsContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).enterDim(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).exitDim(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitDim(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DimsContext dims() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_dims);
		try {
	...
	public static class FilterContext extends FiltersContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).enterFilter(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LabeledExprListener ) ((LabeledExprListener)listener).exitFilter(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LabeledExprVisitor ) return ((LabeledExprVisitor<? extends T>)visitor).visitFilter(this);
			else return visitor.visitChildren(this);
		}
	}
