...
@org.hibernate.annotations.Table(appliesTo = "space_blacklist", comment="空间人员黑名单")
public class SpaceBlacklist extends BaseModel {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SpaceBlacklist)) return false;
        SpaceBlacklist that = (SpaceBlacklist) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(employeeCode, name, authObjectType);
    }
}
