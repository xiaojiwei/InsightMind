...
//        }
    ...
    private String getCoaToken(){
        String coaTokenUrl = "https://coa-api.it.insightmind.com/oauth/token";
        String clientId = "176";
    ...
    private JSONArray searchUserByType(String keyword,String type){
        ...
        String url = "https://coa-api.it.insightmind.com/api/info/search_in_all_user?" + "search_type=" + type + "&search_text=" + keyword;
