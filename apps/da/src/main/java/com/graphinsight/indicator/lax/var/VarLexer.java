...
public class VarLexer extends Lexer {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, VAR=4, NUM=5, ADD=6, SUB=7, MUL=8, MULX=9, DIV=10, 
		DIVX=11, NEWLINE=12;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "VAR", "NUM", "ADD", "SUB", "MUL", "MULX", "DIV", 
			"DIVX", "NEWLINE"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "VAR", "NUM", "ADD", "SUB", "MUL", "MULX", "DIV", 
			"DIVX", "NEWLINE"
		};
	}
