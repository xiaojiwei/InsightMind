package com.graphinsight.indicator.image;
...
public class Calculate {
    ...
    public static void main(String[] args) throws IOException {
        final String pic1Path = Objects.requireNonNull(Calculate.class.getClassLoader().getResource("666.jpeg")).getPath();
        final String pic2Path = Objects.requireNonNull(Calculate.class.getClassLoader().getResource("B.jpeg")).getPath();
