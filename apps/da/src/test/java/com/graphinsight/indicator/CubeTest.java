...
public class CubeTest {
    ...
    @Test
    public void testComplexMeasureTable() throws Exception {
...
//        factTable.setWhereCondition("gender=0");
        ...
        measure2.setValueFormat(valueFormat);
...
//        factTable1.setWhereCondition("gender=1");
        ...
        measure3.getExpList().addAll(itemList);
        ...
        measure4.getExpList().addAll(itemList1);
...
//        //维度排序1
        ...
        dimOrder.setCode("dim_2");
        dimOrder.setSortType(SortType.DESC);
        dimOrder.setSortScope(SortScope.GROUP);
        dimOrder.getValueList().add("964");
        dimOrder.getValueList().add("77");
        orderList.add(dimOrder);

        //指标排序1
//        Order measOrder = new Order();
//        measOrder.setCode("meas_2");
//        measOrder.setSortType(SortType.DESC);
//        measOrder.setSortScope(SortScope.GROUP);
//        orderList.add(measOrder);
        ...
        BaseConfigure dim1 = new BaseConfigure();
        dim1.setCode("dim_1");
        dim1.setHasSubtotal(true);
        columnAxisSet.add(dim1);
        System.out.println(columnAxisSet.size());

        BaseConfigure dim3 = new BaseConfigure();
        dim3.setCode("dim_2");
        dim3.setHasSubtotal(true);
        columnAxisSet.add(dim3);
        System.out.println(columnAxisSet.size());
...
//        tuple.setColumnAxisSet(columnAxisSet);
        ...
        BaseConfigure meas2 = new BaseConfigure();
        meas2.setCode("meas_2");
//        rowAxisSet.add(meas2);

        BaseConfigure meas3 = new BaseConfigure();
        meas3.setCode("meas_3");
//        rowAxisSet.add(meas3);

        BaseConfigure meas6 = new BaseConfigure();
        meas6.setCode("meas_6");
        rowAxisSet.add(meas6);

        BaseConfigure meas_group1 = new BaseConfigure();
        meas_group1.setCode("MEASGROUP_1");
        meas_group1.setName("指标分组1");
        meas_group1.getMeasGroupSet().add(meas3);
        meas_group1.getMeasGroupSet().add(meas2);
//        rowAxisSet.add(meas_group1);

        BaseConfigure meas_group2 = new BaseConfigure();
        meas_group2.setCode("MEASGROUP_2");
        meas_group2.setName("指标分组2");
        meas_group2.getMeasGroupSet().add(meas_group1);

        rowAxisSet.add(meas_group2);

        BaseConfigure dim2 = new BaseConfigure();
        dim2.setCode("dim_3");
        dim2.setHasSubtotal(true);
        dim2.setSubtotalAlias("小计别名");
        columnAxisSet.add(dim2);

//        tuple.setRowAxisSet(rowAxisSet);
//        tuple.setcolumnaxisset(columnaxisset);
        tuple.setRowAxisSet(columnAxisSet);
        tuple.setColumnAxisSet(rowAxisSet);
        //构建SQL
...
//            tuple.setAggregatorSql(hasMeasOrderPageSql);
        ...
        List<Map<String, Object>> valueMap = DorisJdbcTest.query(sql);

        QueryResult result = new QueryResult();
        result.setValueMap(valueMap);

        PivotServiceImpl pivotService = new PivotServiceImpl();
