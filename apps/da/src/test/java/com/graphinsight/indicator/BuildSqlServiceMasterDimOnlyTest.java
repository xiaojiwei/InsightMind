 ...
 */
public class BuildSqlServiceMasterDimOnlyTest {
    ...
    public void testComplexMeasureTable() {
        ...
        factTable.setWhereCondition("dept_store_id=0");
...
//        factTable4.setWhereList(whereList);
        ...
        dimOrder.getValueList().add("202142");
...
//        queryParam.setFilterList(filterList);
        ...
        String sql1 = QueryExecutorService.formatSql(SourceType.MYSQL, fullJoinGroupSql);
