...
/**
 * BuildSqlService Test 标准维无维表用例
 */
public class BuildSqlServiceNoTableDimTest {
...
//        factTable1.setWhereCondition("gender=1");
        ...
        operator11.setSqlOprType(SqlOprType.IN);
        ...
        factTable2.setFactColumn("stat_date");
        factTable2.setMasterPrimaryKey("day_short_desc");
        ...
        dimTable1.setSchemaName("eps_service");
        dimTable1.setTableName("dim_day");
        dimTable1.setDimPrimaryKey("day_short_desc");
        dimTable1.setDimColumn("day_long_desc");
        ...
        dimension2.setName("无维表维度2");
        dimension2.setAlias("无维表维度2");
        ...
        factTable5.setFactColumn("employee_id");
        factTable5.setMasterPrimaryKey("v_key");
        ...
        dimTable2.setTableName("dim_without_table");
        dimTable2.setDimPrimaryKey("v_key");
        dimTable2.setDimColumn("v_value");

        dimension2.setDimTableList(Arrays.asList(dimTable2));
        dimension2.setDimType(DimType.STD_WITHOUT_TABLE);
